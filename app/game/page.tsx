    ...
    >
      <div className="max-w-2xl mx-auto">
        ...
        >
          ...
          <GameStatsCard icon={Zap} label="За клик" value={`+${coinsPerTap}`} backgroundColor="#F6F6F6" />
        </motion.div>

        <GameButton onClick={handleTap} disabled={energy < coinsPerTap} clicks={clicks} coinsPerTap={coinsPerTap} />
