...
export default function UpgradesSection({ onMultitapClick, onEnergyClick }: UpgradesSectionProps) {
  return (
    <div className="mt-6">
      <h2 className="text-lg font-semibold font-heading mb-4" style={{ color: "#101010" }}>
        Улучшения
      </h2>
