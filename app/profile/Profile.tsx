...
export default function ProfilePage() {
  ...
  const [profile] = useState<UserProfile>({
    ...
    firstName: WebApp.initDataUnsafe.user?.first_name || "Имя",
    lastName: WebApp.initDataUnsafe.user?.last_name || "Фамилия",
        ...
        <Card className="mb-6">
          <div className="space-y-4">
            ...
            <InfoItem
              icon={Award}
              label="Роль"
              value={selectedRole === "child" ? "Ребенок" : "Родитель"}
      ...
      <AnimatePresence mode="wait">
        {selectedRole === "child" && (
          ...
          >
            ...
            <div className="mb-6">
              <ChildInfoCard linkedAccount={profile.linkedAccount} />
            </div>
          </motion.div>
        )}
