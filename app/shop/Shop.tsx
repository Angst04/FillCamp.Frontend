...
const mockProducts: Product[] = [
  ...
  },
  {
    ...
    price: 150,
    image:
      "https://images.unsplash.com/photo-1618987044463-54d6e9def3ec?w=400&h=400&fit=crop",
    category: "Аксессуары",
  },
  {
    id: 4,
    ...
    price: 450,
    image:
      "https://images.unsplash.com/photo-1585847927531-cc2b35033d9c?w=400&h=400&fit=crop",
    category: "Посуда",
  },
  {
    id: 5,
...
export default function Shop() {
  ...
  const handleCheckout = () => {
    ...
    WebApp.showConfirm(
      `Оформить заказ на ${totalPrice} бонусов?`,
      (confirmed: boolean) => {
        if (confirmed) {
          ...
          {cart.length === 0 ? (
            ...
            <motion.div key="cart-items">
              ...
              <Button
                ...
                disabled={totalPrice > bonusBalance}
              >
                Оформить заказ
              </Button>
            </motion.div>
